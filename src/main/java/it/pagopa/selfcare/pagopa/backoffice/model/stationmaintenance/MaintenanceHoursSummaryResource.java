...
public class MaintenanceHoursSummaryResource {
    ...
    @Schema(description = "Count of used maintenance's hours")
    @NotNull
    private String usedHours;

    @JsonProperty("scheduled_hours")
    @Schema(description = "Count of scheduled maintenance's hours")
    @NotNull
    private String scheduledHours;

    @JsonProperty("remaining_hours")
    @Schema(description = "Count of remaining maintenance's hours before annual limit")
    @NotNull
    private String remainingHours;

    @JsonProperty("extra_hours")
    @Schema(description = "Count of maintenance's hours that exceed annual limit")
    @NotNull
    private String extraHours;

    @JsonProperty("annual_hours_limit")
    @Schema(description = "Annual limit of maintenance hours")
    @NotNull
