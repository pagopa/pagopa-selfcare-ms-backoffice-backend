...
public class CommissionBundleController {
    ...
    @JwtSecurity(paramName = "ciTaxCode", skipCheckIfParamIsNull = true, allowedProductRole = ADMIN)
    ...
    @OpenApiTableMetadata(readWriteIntense = OpenApiTableMetadata.ReadWrite.READ)
    @JwtSecurity(paramName = "pspTaxCode", allowedProductRole = ADMIN)
    ...
    @OpenApiTableMetadata(readWriteIntense = OpenApiTableMetadata.ReadWrite.WRITE)
    @JwtSecurity(paramName = "ciTaxCode", allowedProductRole = ADMIN)
