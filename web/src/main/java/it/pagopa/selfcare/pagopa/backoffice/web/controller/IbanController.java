...
public class IbanController {
    ...
    public IbansResource getCreditorInstitutionIbans(@RequestBody @NotNull String ecCode){
        log.trace("getCreditorInstitutionsIbans start");
        String xRequestId = UUID.randomUUID().toString();
        log.debug("getCreditorInstitutionsIbans ecCode = {}, xRequestId = {}", ecCode, xRequestId);

        IbansDetails ibans = apiConfigService.getCreditorInstitutionIbans(ecCode, xRequestId);
